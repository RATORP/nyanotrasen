...
FORK_ID = "nyanotrasen"
BUILD_URL = f"https://cdn.nyanotrasen.jick.io/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://cdn.nyanotrasen.jick.io/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://cdn.nyanotrasen.jick.io/version/{{FORK_VERSION}}/download"
